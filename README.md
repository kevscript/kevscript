...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; opacity: 1; background: url('https://github.com/kevscript/kevscript/blob/master/background.jpg?raw=true');]{x0000}$}
