...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: auto; width: 100vw ; object-fit: cover; background-size: cover; opacity: 1; background: url('https://github.com/kevscript/kevscript/blob/master/geralt.mp4?raw=true');]{x0000}$}
